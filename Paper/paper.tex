...
\begin{abstract}
This paper examines how information technology (IT) has transformed the business model of PT Bank Jago Tbk, formerly known as Bank Artos. After its acquisition, Bank Jago shifted from a small traditional bank into a fully digital, ecosystem-based bank. Using a descriptive qualitative approach, this study analyzes how IT changed the bank’s value creation, customer acquisition, and revenue structure. The paper also compares Bank Jago with similar companies in Indonesia and abroad, including ********. 
\end{abstract}
